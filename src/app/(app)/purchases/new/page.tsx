  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        ...
        <p className="text-sm text-muted-foreground">أنشئ الطلب ثم أكمله بالخطوات: موافقة → تم الطلب → استلام.</p>
      </div>
        ...
        <div className="rounded-2xl border bg-background/30 p-4">
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <div className="text-xs text-muted-foreground">الصنف والكمية (بدون أسعار).</div>
            </div>
            <Button
              type="button"
              variant="outline"
              onClick={() => itemsArr.append({ name: "", qty: 1 })}
            >
              إضافة بند
            </Button>
          </div>
